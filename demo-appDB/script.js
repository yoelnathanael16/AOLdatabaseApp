...
async function fetchStats() {
  ...
  document.getElementById('topCategories').innerHTML = data.top_categories.map(c => 
    `<li>${c.CategoryName}: <strong>${c.TotalTerjual} unit</strong></li>`).join('');
    
  document.getElementById('topColors').innerHTML = data.top_colors.map(c => 
